<h2><a href="https://practice.geeksforgeeks.org/problems/count-the-triplets4615/1?page=1&difficulty[]=0&status[]=unsolved&status[]=attempted&sortBy=submissions">Count the triplets</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><div><span style="font-size:18px">Given an array of distinct integers. The task is to count all the triplets such that sum of two elements equals the third element.</span></div>
