<h2><a href="https://practice.geeksforgeeks.org/problems/product-array-puzzle4525/1?page=1&difficulty[]=0&status[]=unsolved&status[]=attempted&sortBy=submissions">Product array puzzle</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>nums[]</strong> of size <strong>n</strong>, construct a Product Array <strong>P</strong> (of same size n) such that<strong> P[i]</strong> is equal to the product of all the elements of <strong>nums</strong> except nums[i].</span></p>
