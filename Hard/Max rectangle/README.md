<h2><a href="https://practice.geeksforgeeks.org/problems/max-rectangle/1?page=1&difficulty[]=2&status[]=unsolved&status[]=attempted&company[]=Google&sortBy=submissions">Max rectangle</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary matrix <strong>M </strong>of size <strong>n X m</strong>. Find the maximum area of a rectangle formed only of <strong>1s</strong> in the given matrix. </span></p>
