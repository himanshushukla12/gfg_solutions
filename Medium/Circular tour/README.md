<h2><a href="https://practice.geeksforgeeks.org/problems/circular-tour-1587115620/1?page=1&difficulty[]=1&difficulty[]=2&status[]=unsolved&status[]=attempted&company[]=Google&sortBy=submissions">Circular tour</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Suppose there is a circle. There are <strong>N</strong> petrol pumps on that circle. You will be&nbsp;given two sets of data.<br>
