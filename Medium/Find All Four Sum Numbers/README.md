<h2><a href="https://practice.geeksforgeeks.org/problems/find-all-four-sum-numbers1732/1?page=1&difficulty[]=1&difficulty[]=2&status[]=unsolved&status[]=attempted&company[]=Google&sortBy=submissions">Find All Four Sum Numbers</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>A</strong> of integers and another number <strong>K</strong>. Find all the <strong>unique&nbsp;</strong>quadruple from the given array that sums up to <strong>K</strong>.</span></p>
